...
<header id="headerWrapper">
	<div id="header">
		<div id="logo">
			<a href="index-1.php"><img src="image/logo0.png" title="Elegance Jewellery Logo" alt="Our Logo" /></a>
		</div>
		<!-- Mini Cart Start-->
		<div id="cart">
			<div class="heading"><a href="cart.php"><span id="cart-total"><?php echo $countrows;?> item(s) - $ <?php echo $totalamount;?></span></a></div>

...
$passport_number = mysqli_real_escape_string($db_conx,$_POST['passport_number']);
	...
	if($rows == 0)
	{	
		$insertSQL = "INSERT INTO users (user_id, name, surname, username, password, email, address, tel, ac_type, user_status, passport_number)
				VALUES (null, '$Fname', '$Lname', '$Uname', '$Pass', '$Email', '$Address', '$Tel', 'user', 1, '$passport_number')";

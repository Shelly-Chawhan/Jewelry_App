								...
								<td bgColor="c6d3ce">
								  ...
								  <tr bgColor="dee7e7">
									...
									<tr bgColor="e7efef">
									  ...
									  <td><b><input type="text" size="15" maxlength="14" name="Passport" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
									</tr>
									<tr bgColor="e7efef">
                                        <td><strong>Upload Passport</strong></td>
                                        <td>
                                            <input type="file" name="passport" required accept=".pdf">
                                            <p>Please submit your original passport when taking jewelry for rent.</p>
                                        </td>
                                    </tr>
									</table>
								</td>

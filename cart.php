				...
				<div class="box-product-1" >
                    ...
                    <?php
                        if (!$rows == 0) {
                            ?>
                        <p align="center">
                            <input type="button" value="Checkout" onClick="javascript:location.href='checkout.php';">
                            <input type="button" value="Rent" onClick="javascript:location.href='checkout.php';">
                        </p>
                    <?php
                        }
                    ?>

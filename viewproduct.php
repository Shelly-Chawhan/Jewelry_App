				...
				<div class="box-content-1">
					<div class="box-product-1" >
						<?php
							...
							$sql = "SELECT COUNT(*) FROM `main_menu`, sub_menu, jewellery where main_menu.mmenu_id = sub_menu.mmenu_id and jewellery.category = sub_menu.id and jewellery.category = $item";
							...
							$sql = " SELECT * FROM `main_menu`, sub_menu, jewellery where main_menu.mmenu_id = sub_menu.mmenu_id and jewellery.category = sub_menu.id and jewellery.category = $item $limit";
